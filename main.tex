...
\paragraph{Mechanics}
\cite{Landau_1982ena,Landau_1997a,Landau_2010a,Landau_2015a}

\paragraph{The Classical Theory of Fields}
\cite{Landau_1987ena,Landau_1992a,Landau_2012a,Landau_2016a}

\paragraph{Quantum Mechanics: Non-Relativistic Theory}
\cite{Landau_1991ena,Landau_1986a}
...
\cite{Landau_1986z,Landau_1980a,Landau_1980b,Lifshitz_1980a,%
Berestetskii_1982a,Lifshitz_1981a,Landau_1987a,%
Landau_1984a} (cleaning and linking to Russian versions needed).

Rest of the current German volumes are
\cite{Landau1991,Landau_1987,Landau_1991a,%
...
\cite{Landau_1974d,Landau_1972a} (cleaning and linking to Russian versions needed)
